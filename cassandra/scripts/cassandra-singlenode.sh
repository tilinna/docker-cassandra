...
sed -i -e "s/^listen_address.*/listen_address: `hostname`/" $CASSANDRA_CONFIG/cassandra.yaml
sed -i -e "s/^rpc_address.*/rpc_address: `hostname`/" $CASSANDRA_CONFIG/cassandra.yaml
